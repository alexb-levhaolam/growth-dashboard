  ...
  return<div id="overview-print"><>
    <div style={{display:'flex',gap:8,marginBottom:14,fontSize:15,color:S.i3,flexWrap:'wrap',alignItems:'center'}}>
      ...
      <span style={{marginLeft:'auto',display:'flex',gap:4}}>
        ...
        {ce&&refreshDaily&&<button onClick={refreshDaily} title="Обновить данные на основе LH Daily" style={{fontSize:17,color:S.sf,background:S.gd,border:'none',borderRadius:8,padding:'10px 18px',cursor:'pointer',fontWeight:600}}>Обновить из Daily <i className="ti ti-info-circle" style={{fontSize:15,opacity:.7}}/></button>}
        {ce&&<button onClick={refreshTotals} style={{display:'none'}}>Обновить итоги</button>}
        <button onClick={print} style={{fontSize:17,color:S.i2,background:S.sf,border:`1px solid ${S.ln}`,borderRadius:8,padding:'10px 18px',cursor:'pointer',fontWeight:600}}>Скачать в PDF</button>
      </span>
    </div>
